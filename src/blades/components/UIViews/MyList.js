...
class MyList extends Component{
	...
	render(){
		return(
			<List renderHeader={()=>"我是华丽的列表头部"} renderFooter={()=>"我是列表尾部"}>
				<Item data-seed="logId">标题文字点击无反馈，文字超长则隐藏</Item>
				<Item wrap>文字超长则折行文字超长则折行文字超长则折行文字超长则折行文字超长则折行文字超长则折行</Item>
				...
				<Item extra={<div>内容内容<Brief>辅助文字内容</Brief></div>} multipleLine align="top">垂直居中对齐</Item>
				<Item extra="内容内容" multipleLine>垂直居中对齐<Brief>辅助文字内容</Brief></Item>
